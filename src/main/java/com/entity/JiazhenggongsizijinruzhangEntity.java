...
public class JiazhenggongsizijinruzhangEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public JiazhenggongsizijinruzhangEntity() {
		
	}
	
	public JiazhenggongsizijinruzhangEntity(T t) {
		try {
