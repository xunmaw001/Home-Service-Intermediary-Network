...
public class YonghuchongzhiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,YonghuchongzhiEntity yonghuchongzhi, HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("yonghu")) {
			yonghuchongzhi.setYonghuming((String)request.getSession().getAttribute("username"));
		}
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,YonghuchongzhiEntity yonghuchongzhi, HttpServletRequest request){
        EntityWrapper<YonghuchongzhiEntity> ew = new EntityWrapper<YonghuchongzhiEntity>();
		PageUtils page = yonghuchongzhiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, yonghuchongzhi), params), params));
        return R.ok().put("data", page);
    }
