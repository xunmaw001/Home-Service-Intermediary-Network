...
public class DiscussjiazhengfuwuController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,DiscussjiazhengfuwuEntity discussjiazhengfuwu, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DiscussjiazhengfuwuEntity discussjiazhengfuwu, HttpServletRequest request){
        EntityWrapper<DiscussjiazhengfuwuEntity> ew = new EntityWrapper<DiscussjiazhengfuwuEntity>();
		PageUtils page = discussjiazhengfuwuService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, discussjiazhengfuwu), params), params));
        return R.ok().put("data", page);
    }
