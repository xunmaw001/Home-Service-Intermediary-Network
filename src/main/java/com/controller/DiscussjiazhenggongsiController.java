...
public class DiscussjiazhenggongsiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,DiscussjiazhenggongsiEntity discussjiazhenggongsi, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DiscussjiazhenggongsiEntity discussjiazhenggongsi, HttpServletRequest request){
        EntityWrapper<DiscussjiazhenggongsiEntity> ew = new EntityWrapper<DiscussjiazhenggongsiEntity>();
		PageUtils page = discussjiazhenggongsiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, discussjiazhenggongsi), params), params));
        return R.ok().put("data", page);
    }
    ...
    public R save(@RequestBody DiscussjiazhenggongsiEntity discussjiazhenggongsi, HttpServletRequest request){
    	discussjiazhenggongsi.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<DiscussjiazhenggongsiEntity> wrapper = new EntityWrapper<DiscussjiazhenggongsiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = discussjiazhenggongsiService.selectCount(wrapper);
