...
public class JiazhenggongsiController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		JiazhenggongsiEntity user = jiazhenggongsiService.selectOne(new EntityWrapper<JiazhenggongsiEntity>().eq("gongsibianhao", username));
		if(user==null || !user.getMima().equals(password)) {
			return R.error("账号或密码不正确");
		}
		String token = tokenService.generateToken(user.getId(), username,"jiazhenggongsi",  "家政公司" );
    ...
    public R register(@RequestBody JiazhenggongsiEntity jiazhenggongsi){
    	...
    	JiazhenggongsiEntity user = jiazhenggongsiService.selectOne(new EntityWrapper<JiazhenggongsiEntity>().eq("gongsibianhao", jiazhenggongsi.getGongsibianhao()));
		if(user!=null) {
    ...
    public R getCurrUser(HttpServletRequest request){
        ...
        JiazhenggongsiEntity user = jiazhenggongsiService.selectById(id);
    ...
    public R resetPass(String username, HttpServletRequest request){
    	...
    	user.setMima("123456");
        jiazhenggongsiService.updateById(user);
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,JiazhenggongsiEntity jiazhenggongsi, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,JiazhenggongsiEntity jiazhenggongsi, HttpServletRequest request){
        EntityWrapper<JiazhenggongsiEntity> ew = new EntityWrapper<JiazhenggongsiEntity>();
		PageUtils page = jiazhenggongsiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, jiazhenggongsi), params), params));
        return R.ok().put("data", page);
    }
