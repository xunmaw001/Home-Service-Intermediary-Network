...
public class FuwufenleiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,FuwufenleiEntity fuwufenlei, HttpServletRequest request){
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,FuwufenleiEntity fuwufenlei, HttpServletRequest request){
        EntityWrapper<FuwufenleiEntity> ew = new EntityWrapper<FuwufenleiEntity>();
		PageUtils page = fuwufenleiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, fuwufenlei), params), params));
        return R.ok().put("data", page);
    }
    ...
    public R save(@RequestBody FuwufenleiEntity fuwufenlei, HttpServletRequest request){
    	fuwufenlei.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<FuwufenleiEntity> wrapper = new EntityWrapper<FuwufenleiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = fuwufenleiService.selectCount(wrapper);
