          ...
          <el-form-item class="input" label="金额" prop="jine">
              <el-input v-model="ruleForm.jine" 
                placeholder="金额" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="入账原因" prop="ruzhangyuanyin">
          <el-input v-model="ruleForm.ruzhangyuanyin" 
              placeholder="入账原因" clearable  :readonly="ro.ruzhangyuanyin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="入账原因" prop="ruzhangyuanyin">
              <el-input v-model="ruleForm.ruzhangyuanyin" 
                placeholder="入账原因" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
  ...
  methods: {
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                ...
                                                // 多级联动参数
                                                              info(id) {
      this.$http({
        url: `jiazhenggongsizijinruzhang/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
      ...
      this.$http({
        ...
        if (valid) {
          this.$http({
            url: `jiazhenggongsizijinruzhang/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jiazhenggongsizijinruzhangCrossAddOrUpdateFlag = false;
                  this.parent.search();
