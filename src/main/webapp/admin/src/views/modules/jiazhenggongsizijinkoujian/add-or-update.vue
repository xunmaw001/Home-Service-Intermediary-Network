  ...
  methods: {
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                ...
                                                // 多级联动参数
                                                              info(id) {
      this.$http({
        url: `jiazhenggongsizijinkoujian/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
      ...
      this.$http({
        ...
        if (valid) {
          this.$http({
            url: `jiazhenggongsizijinkoujian/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jiazhenggongsizijinkoujianCrossAddOrUpdateFlag = false;
                  this.parent.search();
