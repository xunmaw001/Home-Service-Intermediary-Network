        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tupian" label="图片" prop="tupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tupian.split(',')" :src="item" width="100" height="100">
                                                                                              ...
                                                                                              <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="服务宗旨" prop="fuwuzongzhi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="服务宗旨"
                  v-model="ruleForm.fuwuzongzhi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.fuwuzongzhi" label="服务宗旨" prop="fuwuzongzhi">
                    <span>{{ruleForm.fuwuzongzhi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tupian = true;
            continue;
	            	            ...
	            	            if(o=='fuwuzongzhi'){
            this.ruleForm.fuwuzongzhi = obj[o];
	    this.ro.fuwuzongzhi = true;
            continue;
          }
	            	            if(o=='fuwuneirong'){
