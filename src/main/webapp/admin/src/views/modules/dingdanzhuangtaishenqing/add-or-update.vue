    ...
    >
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="服务地点" prop="fuwudidian">
          <el-input v-model="ruleForm.fuwudidian" 
              placeholder="服务地点" clearable  :readonly="ro.fuwudidian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="服务地点" prop="fuwudidian">
              <el-input v-model="ruleForm.fuwudidian" 
                placeholder="服务地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                        ...
                                                                                        // 多级联动参数
                                                                                                                info(id) {
      this.$http({
        url: `dingdanzhuangtaishenqing/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `dingdanzhuangtaishenqing/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.dingdanzhuangtaishenqingCrossAddOrUpdateFlag = false;
                  this.parent.search();
