  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.17);borderRadius:10px">
        <h1 class="h1" style="color:#000;fontSize:28px;">家政服务中介网注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="身份证" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.shenfenzheng" autocomplete="off" placeholder="身份证" type="text" />
																								...
																								<!-- <div v-if="tableName=='jiazhenggongsi'" class="input-group">
			   <div class="label">公司编号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.gongsibianhao" class="input" type="text" placeholder="公司编号">
			   </div>
			 </div> -->
			<el-form-item label="公司编号" class="input" v-if="tableName=='jiazhenggongsi'">
			  <el-input v-model="ruleForm.gongsibianhao" autocomplete="off" placeholder="公司编号" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='jiazhenggongsi'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='jiazhenggongsi'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='jiazhenggongsi'" class="input-group">
			...
			<el-form-item label="公司名称" class="input" v-if="tableName=='jiazhenggongsi'">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='jiazhenggongsi'">
