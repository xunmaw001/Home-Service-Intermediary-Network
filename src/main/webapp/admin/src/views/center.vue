     ...
     <el-row>
        ...
        <el-form-item   v-if="flag=='yonghu'"  label="身份证" prop="shenfenzheng">
          <el-input v-model="ruleForm.shenfenzheng"               placeholder="身份证" clearable></el-input>
                                                ...
                                                <el-col :span="12">
        <el-form-item   v-if="flag=='jiazhenggongsi'"  label="公司编号" prop="gongsibianhao">
          <el-input v-model="ruleForm.gongsibianhao" readonly              placeholder="公司编号" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        <el-form-item   v-if="flag=='jiazhenggongsi'"  label="密码" prop="mima">
          <el-input v-model="ruleForm.mima"               placeholder="密码" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        <el-form-item   v-if="flag=='jiazhenggongsi'"  label="公司名称" prop="gongsimingcheng">
          <el-input v-model="ruleForm.gongsimingcheng"               placeholder="公司名称" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        <el-form-item   v-if="flag=='jiazhenggongsi'"  label="联系电话" prop="lianxidianhua">
          <el-input v-model="ruleForm.lianxidianhua"               placeholder="联系电话" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="24">  
        <el-form-item v-if="flag=='jiazhenggongsi'" label="图片" prop="tupian">
          <file-upload
          tip="点击上传图片"
          action="file/upload"
          :limit="3"
          ...
          @change="jiazhenggongsitupianUploadChange"
          ></file-upload>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        <el-form-item   v-if="flag=='jiazhenggongsi'"  label="服务宗旨" prop="fuwuzongzhi">
          <el-input v-model="ruleForm.fuwuzongzhi"               placeholder="服务宗旨" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        <el-form-item   v-if="flag=='jiazhenggongsi'"  label="服务内容" prop="fuwuneirong">
          <el-input v-model="ruleForm.fuwuneirong"               placeholder="服务内容" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        <el-form-item   v-if="flag=='jiazhenggongsi'"  label="公司文化" prop="gongsiwenhua">
          <el-input v-model="ruleForm.gongsiwenhua"               placeholder="公司文化" clearable></el-input>
        </el-form-item>
      </el-col>
...
export default {
  ...
  methods: {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                jiazhenggongsitupianUploadChange(fileUrls) {
        ...
        return
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                if( 'jiazhenggongsi' ==this.flag && this.ruleForm.lianxidianhua&&(!isMobile(this.ruleForm.lianxidianhua))){
